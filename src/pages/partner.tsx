                  ...
                  >
                    <div className="relative group max-w-[80%]">
                      ...
                      <div 
                        ...
                        className={`rounded-2xl px-4 py-2.5 text-xs font-semibold border leading-relaxed relative ${
                          isSentByMe
                            ? 'bg-gradient-to-r from-primary to-secondary text-white border-primary/20 rounded-tr-sm shadow-sm'
                      ...
                      >
                        ...
                        {msg.sticker ? (
                          <div className="text-center py-1">
                            ...
                            <span className={`text-[10px] font-bold ${isSentByMe ? 'text-white/90' : 'text-[#3d3050] dark:text-[#c8bedd]'}`}>
                              {msg.sticker}
                            </span>
                          </div>
                        ) : (
                        ...
                        {/* Reaction Display */}
                        {msg.reaction && (
                          <div className={`absolute -bottom-2 ${isSentByMe ? '-left-2' : '-right-2'} bg-white dark:bg-[#16102a] text-xs px-1.5 py-0.5 rounded-full border border-black/8 dark:border-[#3a2d58] shadow-md`}>
                            {msg.reaction}
                          </div>
                        )}
                      </div>
